...
urlpatterns = [
    ...
    path('covid/virtual_library', views.covid_virtual_library, name='covid_virtual_library'),
    path('covid/virtual_library/<section>', views.covid_virtual_library,
         name='covid_virtual_library'),
    path('fitfor55/landing', views.fitfor55_workspace_landing, name='fitfor55_landing'),
    path('fitfor55/scientific_module', views.fitfor55_scientific_module, name='fitfor55_scientific_module'),
    path('fitfor55/fitfor55_public_ui', views.fitfor55_public_ui, name='fitfor55_public_ui'),
    path('fitfor55/virtual_library', views.fitfor55_virtual_library, name='fitfor55_virtual_library'),
    path('fitfor55/virtual_library/<section>', views.fitfor55_virtual_library,
         name='fitfor55_virtual_library'),
    path('feasibility/landing', views.feasibility_workspace_landing, name='feasibility_landing'),
    path('feasibility/scientific_module', views.feasibility_scientific_module, 
     name='feasibility_scientific_module'),
    path('feasibility/feasibility_public_ui', views.feasibility_public_ui, name='feasibility_public_ui'),
    path('feasibility/virtual_library', views.feasibility_virtual_library, name='feasibility_virtual_library'),
    path('feasibility/virtual_library/<section>', views.feasibility_virtual_library,
         name='feasibility_virtual_library'),
    path('feasibility/back_to_landing', views.redirect_to_landing),
    path('ndca/landing', views.ndca_workspace_landing, name='ndca_landing'),
    path('ndca/scientific_module', views.ndca_scientific_module, 
     name='ndca_scientific_module'),
